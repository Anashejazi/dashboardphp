...
<div class="container">
    ...
    <h1 class="text-center my-3">categories Table</h1>
    <a href="addcategories.php" class="btn btn-info mb-2">Add</a>
    <?php
            ...
            ?>
                <tr>
                    ...
                    <td class="d-flex" style="gap: 10px">
                        <form action="deletecatories.php" method="POST">
